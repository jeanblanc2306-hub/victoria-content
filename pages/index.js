    ...
    return (
      <div
        ...
        style={{
          ...
          cursor: "pointer",
          zIndex: 999,
          boxShadow: "0 4px 20px rgba(255,78,0,0.4)",
        }}
      >
    ...
    <>
                ...
                <div key={post.id} className="post">
                  <div className="post-header">
                    <div className="post-avatar">
                      {avatarUrl ? <img src={avatarUrl} alt="" className="round-img" /> : profile.name?.[0] || "V"}
                    </div>
      ...
      <style jsx>{`
        ...
        .hero-gradient {
          position: absolute;
          inset: 0;
          background: radial-gradient(ellipse at 60% 40%, #3d1a4e 0%, #1a0a2e 50%, #080808 100%);
        }
